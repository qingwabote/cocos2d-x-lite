...
extern se::Object* __jsb_SkeletonDataCache_proto;
extern se::Class* __jsb_SkeletonDataCache_class;

bool js_register_SkeletonDataCache(se::Object* obj);
bool register_all_cocos2dx_spine(se::Object* obj);
SE_DECLARE_FUNC(js_cocos2dx_spine_SkeletonDataCache_addSkeletonData);
SE_DECLARE_FUNC(js_cocos2dx_spine_SkeletonDataCache_addSkeletonDataAsync);
SE_DECLARE_FUNC(js_cocos2dx_spine_SkeletonDataCache_addAtlas);
SE_DECLARE_FUNC(js_cocos2dx_spine_SkeletonDataCache_getInstance);
SE_DECLARE_FUNC(js_cocos2dx_spine_SkeletonDataCache_SkeletonDataCache);
